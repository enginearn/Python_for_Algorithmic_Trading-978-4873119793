...
# of Linear Regression Trading Strategy
...
class LRVectorBacktester(object):
    ...
    amount: int, float
        amount ro be invested at the beginning
    tc: float
    ...
    select_data:
        selects a sub-set of the data set
    prepare_lags:
        prepares the lagged data for the regression
    fit_model:
        implements the regression step
    run_strategy:
        runs the backtest for the trading strategy
    plot_results:
    ...
    def run_strategy(self, start_in, end_in,
                    start_out, end_out, lags=3):
...
if __name__ == '__main__':
    lrbt = LRVectorBacktester('.SPX', '2010-01-01', '2018-06-29', 10000, 0)
    print(lrbt.run_strategy('2010-01-01', '2019-12-31',
                            '2010-01-01', '2019-12-31'))
    print(lrbt.run_strategy('2010-01-01', '2015-12-31',
                            '2016-01-01', '2019-12-31'))

    lrbt = LRVectorBacktester('GDX', '2010-01-01', '2019-12-31', 10000, 0.0001)
    print(lrbt.run_strategy('2010-01-01', '2019-12-31',
                            '2010-01-01', '2019-12-31', lags=5))
    print(lrbt.run_strategy('2010-01-01', '2015-12-31',
                            '2016-01-01', '2019-12-31', lags=5))
